...
const InsightsGaming = () => {
    const data = [
        { time: '4HRS 27MINS', text: 'COD Warzone session with Jaypee', amount: '54.72', date: '3:27PM' },
        { time: '4HRS 27MINS', text: 'COD Warzone session with Jaypee', amount: '54.72', date: '3:27PM' },
        { time: '4HRS 27MINS', text: 'COD Warzone session with Jaypee', amount: '54.72', date: '3:27PM' },
        { time: '4HRS 27MINS', text: 'COD Warzone session with Jaypee', amount: '54.72', date: '3:27PM' },
        { time: '4HRS 27MINS', text: 'COD Warzone session with Jaypee', amount: '54.72', date: '3:27PM' },
      ...
      return (
        <Layout insights={true}>
          <View style={tw`flex-1 pt-4`}>
            <Text style={[tw`text-[#fff] text-[30px] mb-4`, { fontFamily: 'DarkerGrotesque_500Medium' }]}>CO - GAMING History</Text>
                ...
                <View key={index} style={tw`flex flex-row justify-between px-6 py-3 bg-[#fff] rounded-xl mb-3 `}>
                  ...
                  <View style={tw``}>
                    ...
                    <View style={tw`flex flex-row`}>
                      ...
                      <Feather name="monitor" size={24} color="#00000080" style={tw`ml-1`} />
                    </View>
                  </View>
                </View>
              ))}
